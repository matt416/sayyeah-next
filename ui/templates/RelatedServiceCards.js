...
export default function RelatedServiceCards({
  ...
  return (
    <Grid>
      ...
      {getItemsFromList(items, RELATED_SERVICE_SUMMARIES).map(
        ({ title, body, action }) => (
          <Card className="bg-sy-sunshine p-6 flex flex-col">
            <h3 className="text-24 font-bold mb-4">{title}</h3>
