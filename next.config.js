module.exports = {
  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination:
          "/digital-insights/2021-website-builder-accessibility-comparison/",
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination:
          "/inclusive-website-audit/inclusive-website-audit-process/",
        permanent: true,
      },
      {
        source: "/essential-website-audit/checkout/",
      ...
      {
        source: "/inclusiveguide",
        destination: "https://inclusive-design.sayyeah.courses",
        permanent: true,
      },
    ];
  },
  ...
  async rewrites() {
    // Fallback on production, don't do this locally please!
