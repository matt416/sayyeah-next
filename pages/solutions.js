    ...
    <Layout>
      <Main>
        ...
        <Hero
          {...{
            name: "Solutions",
            title: "Deliver transformational tech + education experiences",
        ...
        >
          <Flex>
            {[
              ...
              <div
                className="grid grid-cols-1 sm:grid-cols-2 gap-4 gap-x-12 py-16"
                key={key}
              >
                ...
                <div className="flex flex-col">
                  ...
                  <ul className="space-y-8 flex-1 flex flex-col">
                    {item?.questions?.map((question, index) => (
                      <Quote nodeType="li" key={index} quoteColor="bronze">
                        {question}
                      </Quote>
                    ))}
                  </ul>
                ...
                <div className="flex flex-col items-stretch justify-items-stretch">
                  ...
                  <Card className="flex flex-col flex-1">
                    <Card.Content className="flex flex-col items-start flex-1 h-full">
                      {item.answer?.img?.src ? (
                        <Image
                          src={item.answer.img.src}
                          alt={item.answer.img.alt}
                          width="56"
                          height="56"
                        />
                      ) : null}

                      <ReactMarkdown className="text-20 leading-normal mb-4">
                        {item?.answer?.body}
                      </ReactMarkdown>
